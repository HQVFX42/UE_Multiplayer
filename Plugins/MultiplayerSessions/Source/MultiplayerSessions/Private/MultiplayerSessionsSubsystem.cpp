...
void UMultiplayerSessionsSubsystem::CreateSession(int32 NumbPublicConnections, FString MatchType)
{
	...
	if (ExistingSession)
	{
		...
		LastNumPublicConnections = NumbPublicConnections;
	...
	LastSessionSettings->NumPublicConnections = NumbPublicConnections;
...
void UMultiplayerSessionsSubsystem::OnDestroySessionComplete(FName SessionName, bool bWasSuccessful)
{
	...
	if (bWasSuccessful and bCreateSessionOnDestroy)
	{
